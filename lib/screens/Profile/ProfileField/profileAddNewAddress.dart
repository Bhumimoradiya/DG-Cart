...
class ProfileAddNewAddress extends StatefulWidget {
  const ProfileAddNewAddress({super.key});

  @override
  State<ProfileAddNewAddress> createState() => _ProfileAddNewAddressState();
}

class _ProfileAddNewAddressState extends State<ProfileAddNewAddress> {
        ...
        child: Row(
          ...
          children: [
            ElevatedButton(
                ...
                onPressed: () {
                  nextscreen(context, profileAddress());
                },
                child: Text(
                  "Cancel",
                  style: TextStyle(

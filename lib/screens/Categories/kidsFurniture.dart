...
class KidsFurniture extends StatefulWidget {
  const KidsFurniture({super.key});

  @override
  State<KidsFurniture> createState() => _KidsFurnitureState();
}

class _KidsFurnitureState extends State<KidsFurniture> {
